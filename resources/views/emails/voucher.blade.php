                                                                                                                    ...
                                                                                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="border-bottom:1px solid rgb(204,204,204)">
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:277.778px;text-align:right;color:rgb(127,140,157);font-family:sans-serif;font-size:13px;line-height:23px">{{$data->montant}} DH</td>
                                                                                                                            </tr>
                                                                                                                        </tbody>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                                                    ...
                                                                                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="width:277.778px;text-align:right;color:rgb(119,119,119);font-weight:bold;font-family:sans-serif;font-size:13px;line-height:23px">{{$data->montant}} DH</td>
                                                                                                                            </tr>
                                                                                                                        </tbody>
                                                                                                                    </table>
                                                                                                                </td>
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="color:rgb(127,140,157);font-family:sans-serif;font-size:13px;line-height:16px">
                                                                                                                    Vous recevrez votre contrat par e-mail. Veuillez le signer et nous le retourner. Vous disposez de plusieurs moyens de nous le renvoyer:<br>
                                                                                                                    Télécharger une photo claire du contrat signé dans la rubrique "Espace personnel", l'envoyer dans notre e-mail : reclamations@wafaimaassistance.com ou par Whatsapp au numéro +212 7 07 94 08 30<br>
                                                                                                                    Déposer l'original dans nos locaux au 217 boulevard Zerktouni 20100 Casablanca.
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="color:rgb(127,140,157);font-family:sans-serif;font-size:11px;line-height:16px">
                                                                                                                    ...
                                                                                                                    <br>Prière de ne pas répondre à cette adresse email.
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td height="20" style="font-size:0px;line-height:0">&nbsp;</td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="color:rgb(127,140,157);font-family:sans-serif;font-size:13px;line-height:16px;font-weight:bold">Pour toutes remarques, questions, ou réclamations, notre Centre Service Client est à votre disposition au 05 22 58 95 15, reclamations@wafaimaassistance.com:&nbsp;
                                                                                                                    <br>
                                                                                                                    <div style="padding-top:10px">Du Lundi au Vendredi De 8h30 à 12h00 et 14h00 à 18h30&nbsp;
                                                                                                                    </div>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <table width="270" cellspacing="0" cellpadding="0" border="0" bgcolor="#ededed" align="left">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="font-family: sans-serif;font-size: 12px;">© Assurance Voyage {{date('Y')}}</td>
                                                                                                <td width="20"></td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
