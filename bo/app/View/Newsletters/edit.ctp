...
<div id="tabs" class="pageContentContainer clearfix">
    <div class="leftNav">
		<?php echo $this->Html->link('Template1', array('controller' => 'newsletters', 'action' => 'index'),array('class' => 'selected')) ?>
    ...
    <div class="rightNavContent">
        <div id="step1" class="">
            ...
            <div id="spectacleInfoData" style="min-height: 250px;">
                ...
                <h2 class="pageTitle"><span> Modifier une Newsletter</span></h2>
                <div>
                    <?php
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<div style="margin-top:5px">
                                    ...
                                    //echo $this->Form->input('body', array('value' => file_get_contents($this->Html->url( '/files/html/template2.html', true ))));
                                    //echo file_get_contents($this->Html->url( '/files/html/template2.html', true ));
