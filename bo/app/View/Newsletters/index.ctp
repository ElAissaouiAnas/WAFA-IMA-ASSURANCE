                            ...
                            <tbody>
                                ...
                                if (count($newsletters)) {
                                    foreach ($newsletters as $newsletter) {
                                        ?>
                                        <tr>
                                            <td><?php echo $this->Html->link($newsletter['Newsletter']['id'], array('controller' => 'newsletters', 'action' => 'edit', $newsletter['Newsletter']['id'])) ?></td>
                                            <td><?php echo $this->Html->link($newsletter['Newsletter']['name'], array('controller' => 'newsletters', 'action' => 'edit', $newsletter['Newsletter']['id'])) ?></td>
