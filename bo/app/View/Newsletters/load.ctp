<html>
<body>
<table style="background-color: #585858; width: 100%; font-family: Arial,Sindbad,Kalimati,Verdana,Arial,sans-serif; border: 1px solid #333333;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
...
<tr>
<td style="font-size: 22px; font-family: Arial,Sindbad,Kalimati,Verdana,sans-serif; color: #333333; text-decoration: none; line-height: 1.231em;" align="left">Title</td>
</tr>
<tr>
...
<tbody>
<td rowspan="5" width="96" align="left" valign="top"><a href="http://www.lavion.ma/" target="_blank"><?php echo $this->Html->image(FULL_BASE_URL.'/newsletter/img/deals/'.$deal['Deal']['logoCompAir'] , array('width' => '96','height' => '96')); ?></a></td>
<tr>
...
<a href="<?php echo $deal['Deal']['url1'] ?>" target="_blank" style="color: #333;"><div style="font-size: 11px; font-family: Arial,Sindbad,Kalimati,Verdana,sans-serif; color: #333333; text-decoration: none;"><span style="font-size: 13px; font-weight: bold;"><?php echo $deal['Deal']['arriver1'] ?>: <?php echo $deal['Deal']['prixArriver1'] ?> </span> (<?php echo $deal['Deal']['descArriver1'] ?>)</div></a>
</td>
</tr>
  <?php } ?>
...
<a href="<?php echo $deal['Deal']['url2'] ?>" target="_blank" style="color: #333;"><div style="font-size: 11px; font-family: Arial,Sindbad,Kalimati,Verdana,sans-serif; color: #333333; text-decoration: none;"><span style="font-size: 13px; font-weight: bold;"><?php echo $deal['Deal']['arriver2'] ?>: <?php echo $deal['Deal']['prixArriver2'] ?> </span> (<?php echo $deal['Deal']['descArriver2'] ?>)</div></a>
</td>
</tr>
  <?php } ?>
...
<tr>
<td height="20" align="left" valign="top">
<a href="<?php echo $deal['Deal']['url3'] ?>" target="_blank" style="color: #333;"><div style="font-size: 11px; font-family: Arial,Sindbad,Kalimati,Verdana,sans-serif; color: #333333; text-decoration: none;"><span style="font-size: 13px; font-weight: bold;"><?php echo $deal['Deal']['arriver3'] ?>: <?php echo $deal['Deal']['prixArriver3'] ?> </span> (<?php echo $deal['Deal']['descArriver3'] ?>)</div></a>
</td>
</tr>
  <?php } ?>
<tr>
...
<tbody>
<tr>
<td align="left"><a class="pricelink" style="font-weight: bold; font-size: 11px; font-family: Arial,Sindbad,Kalimati,Verdana,sans-serif; color: #1d6dcf; text-decoration: none;" href="http://www.lavion.ma/" target="_blank"><?php echo $deal['Deal']['compAir'] ?></a></td>
<td align="right">&nbsp;</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td rowspan="5" width="96" align="left" valign="top"><a href="http://www.lavion.ma/" target="_blank"><img src="http://www.royalairmaroc.com/images/logo/ram_be.gif" border="0" alt="" width="96" height="96" /></a></td>
<td rowspan="5" width="8">&nbsp;</td>
...
<tr>
<td height="20" align="left" valign="middle">
<a href="http://www.lavion.ma/" target="_blank"><div style="font-size: 11px; font-family: Arial,Sindbad,Kalimati,Verdana,sans-serif; color: #333333; text-decoration: none;"><span style="font-size: 13px; font-weight: bold;">Paris: 750DH A/R </span> (Tarif TTC valable du 12/8/2013 au 20/8/2013)</div></a>
</td>
</tr>
<tr>
<td height="20" align="left" valign="middle">
...
<tr>
<td style="font-size: 0px; line-height: 0em;height: 5px;" width="5" height="5" valign="top"><img style="display: block;" src="https://www.kayak.com/eimg/coreImages/corners/585858-464646-ffffff-bl.png" alt="" width="5" height="5" /></td>
<td style="font-size: 0px; line-height: 0em;height: 5px;" colspan="3" height="5"><img style="display: block;height: 5px;" src="https://www.kayak.com/eimg/coreImages/corners/bubble-bottom-464646.png" alt="" width="594" height="5" /></td>
<td style="font-size: 0px; line-height: 0em;height: 5px;" width="5" height="5" valign="top"><img style="display: block;" src="https://www.kayak.com/eimg/coreImages/corners/585858-464646-ffffff-br.png" alt="" width="5" height="5" /></td>
</tr>
</tbody>
</table>
...
<td style="border-left: 1px solid #464646; font-size: 0px; line-height: 0em;" width="4">&nbsp;</td>
<td style="font-size: 0px; line-height: 0em;" width="20">&nbsp;</td>
<td><span style="font-family: Arial,Sindbad,Kalimati,Verdana,Arial,sans-serif; font-size: 22px; color: #333333;">Lavion.ma</span> 
<table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td style="font-size: 0px; line-height: 0em; background-color: #ffffff; width: 100%;" height="8">&nbsp;</td>
...
<tr>
<td style="font-size: 0px; line-height: 0em; border-bottom: 1px solid #E2E2E2;" height="2">&nbsp;</td>
</tr>
<tr>
<td style="font-size: 0px; line-height: 0em;" height="2">&nbsp;</td>
</tr>
<tr>
...
<tr>
<td style="font-family: Arial,Sindbad,Kalimati,Verdana,Arial,sans-serif; color: #bababa; font-size: 12px; line-height: 1.6em;" width="100%" align="center">193, Bd de la Résistance, 20 330 Casablanca</td>
</tr>
<tr>
