...
<div id="nowDealsContainer" class="pageContentContainer clearfix">
    ...
    <div class="rightNavContent" id="nowDealsRightNavContent1">
        <div class="grid_24">
            ...
            <?php echo $this->Html->link('<span>+</span> Nouveau', array('controller' => 'newsletters', 'action' => 'add3'), array('escape' => false, 'class' => 'right button gray newDeal radioStyle blueText')) ?>
                            ...
                            <tbody>
                                ...
                                if (count($newsletters)) {
                                    foreach ($newsletters as $newsletter) {
                                        ?>
                                        <tr>
                                            <td><?php echo $this->Html->link($newsletter['Newsletter']['id'], array('controller' => 'newsletters', 'action' => 'edit3', $newsletter['Newsletter']['id'])) ?></td>
                                            <td><?php echo $this->Html->link($newsletter['Newsletter']['name'], array('controller' => 'newsletters', 'action' => 'edit3', $newsletter['Newsletter']['id'])) ?></td>
