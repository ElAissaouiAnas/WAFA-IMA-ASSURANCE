								...
								// print_r($payments);exit();
									...
									// echo $v['Payment']['pnr']
										...
										?>">
											...
											<td>
												<?php echo $v['Payment']['pnr']; ?><br>
												<small><?php echo $v['Payment']['service']; ?></small>
											</td>
											<td><?php 
											...
											<td style="max-width:180px;max-width:180px;text-overflow: ellipsis;overflow: hidden;"><?php echo $v['Payment']['buyerPhone'] ?></td>
											...
											<td><?php 
												if(!$v['Payment']['cancel'] && $v['Payment']['valid'] && $v['Payment']['status']== 'PAID'){
													...
													echo 'CANCELLED';
												}elseif($v['Payment']['expirationDate'] < date('Y-m-d H:i:s') && $v['Payment']['status']== 'PENDING'){
